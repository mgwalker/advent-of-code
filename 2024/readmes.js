...
await Promise.all(
  aoc.days
    ...
    .map(async ({ part1, part2 }, i) => {
      ...
      const response = await fetch(`https://adventofcode.com/2024/day/${day}`, {
        headers: {
      ...
      const readme = `# 🎄 Advent of Code 2024 - day ${day} 🎄
[Original problem](https://adventofcode.com/2024/day/${day})
