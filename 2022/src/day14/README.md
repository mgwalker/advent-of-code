...
<article class="day-desc"><h2>--- Day 14: Regolith Reservoir ---</h2><p>The distress signal leads you to a giant waterfall! Actually, hang on - the signal seems like it's coming from the waterfall itself, and that doesn't make any sense. However, you do notice a little path that leads <strong>behind</strong> the waterfall.</p>
...
<p>Fortunately, your <a href="/2018/day/17">familiarity</a> with analyzing the path of falling material will come in handy here. You scan a two-dimensional vertical slice of the cave above you (your puzzle input) and discover that it is mostly <strong>air</strong> with structures made of <strong>rock</strong>.</p>
...
<p>Sand is produced <strong>one unit at a time</strong>, and the next unit of sand is not produced until the previous unit of sand <strong>comes to rest</strong>. A unit of sand is large enough to fill one tile of air in your scan.</p>
...
..###ooo#.
....oooo#.
.<strong>o</strong>.ooooo#.
#########.
</code></pre>
<p>Once all <code><strong>24</strong></code> units of sand shown above have come to rest, all further sand flows out the bottom, falling into the endless void. Just for fun, the path any new sand takes before falling forever is shown here with <code>~</code>:</p>
<pre><code>.......+...
.......~...
......~o...
.....~ooo..
...
<p>Using your scan, simulate the falling sand until the source of the sand becomes blocked. <strong>How many units of sand come to rest?</strong></p>
</article>
